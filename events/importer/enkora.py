...
class EnkoraImporter(Importer):
    ...
    def import_places(self):
        ...
        for course_id, course in reservation_event_groups.items():
            ...
            place_count += 1
            enkora_place = self._handle_place(course["location_id"], location_mapping)
            syncher.mark(enkora_place)
    ...
    def generate_documentation_md() -> str:  # noqa: C901
        ...
        for location_id, mapping in EnkoraImporter.place_map.items():
            ...
            if mapping["tprek-id"]:
                ...
                longtitude = mapping["epsg:4326"][1]
    ...
    def build_sub_events(
        ...
        for reservation_event in course["reservation_events"]:
            ...
            # Override?
            for key, val in overridden_event_data.items():
                sub_event_data[key] = val
    ...
    @transaction.atomic
    def _handle_place(self, enkora_place_id: int, info_in: dict) -> Place:
        # Note:
        ...
        longtitude = info_in["epsg:4326"][1]
        latitude = info_in["epsg:4326"][0]
        position = Point(
            longtitude, latitude, srid=settings.WGS84_SRID
