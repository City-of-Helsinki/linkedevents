...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Place.elevation'
        db.delete_column(u'events_place', 'elevation')
        ...
        db.add_column(u'events_event', 'offers',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Offer'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.origin_id'
        db.add_column(u'events_event', 'origin_id',
        ...
        m2m_table_name = db.shorten_name(u'events_event_creator')
        ...
        m2m_table_name = db.shorten_name(u'events_event_performer')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'events.event'], null=False)),
            ('person', models.ForeignKey(orm[u'events.person'], null=False))
        ...
        # Changing field 'Event.date_published'
        db.alter_column(u'events_event', 'date_published', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding field 'Category.category_for'
        db.add_column(u'events_category', 'category_for',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GeoCoordinates.place'
        db.delete_column(u'events_geocoordinates', 'place_id')

        # Adding field 'GeoCoordinates.id'
        db.add_column(u'events_geocoordinates', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Place.elevation'
        db.add_column(u'events_place', 'elevation',
        ...
        db.add_column(u'events_event', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_creators', null=True, to=orm['events.Person'], blank=True),
                      keep_default=False)

        # Deleting field 'Event.offers'
        db.delete_column(u'events_event', 'offers_id')

        # Deleting field 'Event.origin_id'
        db.delete_column(u'events_event', 'origin_id')
        ...
        db.delete_table(db.shorten_name(u'events_event_creator'))

        # Removing M2M table for field performer on 'Event'
        db.delete_table(db.shorten_name(u'events_event_performer'))


        # Changing field 'Event.date_published'
        db.alter_column(u'events_event', 'date_published', self.gf('django.db.models.fields.DateTimeField')(default=None))
        # Deleting field 'Category.category_for'
        db.delete_column(u'events_category', 'category_for')

        # Adding field 'GeoCoordinates.place'
        db.add_column(u'events_geocoordinates', 'place',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['events.Place'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'GeoCoordinates.id'
        db.delete_column(u'events_geocoordinates', u'id')
    ...
    models = {
        ...
        u'events.geoshape': {
            ...
            'place': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'geo_shapes'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['events.Place']"}),
