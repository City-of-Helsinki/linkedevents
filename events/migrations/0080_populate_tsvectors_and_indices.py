...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.SeparateDatabaseAndState(
            database_operations=[
                migrations.RunSQL(sql="CREATE INDEX CONCURRENTLY events_finnish_content_index ON events_event USING GIN (search_vector_fi);",
                                  reverse_sql="DROP INDEX events_finnish_content_index;"
                ),
                migrations.RunSQL(sql="CREATE INDEX CONCURRENTLY events_swedish_content_index ON events_event USING GIN (search_vector_sv);",
                                  reverse_sql="DROP INDEX events_swedish_content_index;"
                ),
                migrations.RunSQL(sql="CREATE INDEX CONCURRENTLY events_english_content_index ON events_event USING GIN (search_vector_en);",
