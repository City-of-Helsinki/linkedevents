...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.url_fi'
        db.add_column(u'events_event', 'url_fi',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.url_sv'
        db.add_column(u'events_event', 'url_sv',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.url_en'
        db.add_column(u'events_event', 'url_en',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Event.url_fi'
        db.delete_column(u'events_event', 'url_fi')

        # Deleting field 'Event.url_sv'
        db.delete_column(u'events_event', 'url_sv')

        # Deleting field 'Event.url_en'
        db.delete_column(u'events_event', 'url_en')
