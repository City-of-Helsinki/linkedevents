...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offer.seller_object_id'
        db.alter_column(u'events_offer', 'seller_object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Offer.seller_object_id'
        db.alter_column(u'events_offer', 'seller_object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
