...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='place',
            name='n_events',
            field=models.IntegerField(db_index=True, default=0, editable=False, help_text='number of events in this location', verbose_name='event count'),
        ),
        migrations.AlterField(
            model_name='event',
            name='location',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='events', to='events.Place'),
        ),
