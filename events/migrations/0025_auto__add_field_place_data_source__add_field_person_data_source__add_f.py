...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.data_source'
        db.add_column(u'events_place', 'data_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.DataSource'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.data_source'
        db.add_column(u'events_person', 'data_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.DataSource'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostalAddress.data_source'
        db.add_column(u'events_postaladdress', 'data_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.DataSource'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Offer.data_source'
        db.add_column(u'events_offer', 'data_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.DataSource'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.data_source'
        db.add_column(u'events_category', 'data_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.DataSource'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.data_source'
        db.add_column(u'events_organization', 'data_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.DataSource'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.data_source'
        db.add_column(u'events_language', 'data_source',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.DataSource'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.data_source'
        db.delete_column(u'events_place', 'data_source_id')

        # Deleting field 'Person.data_source'
        db.delete_column(u'events_person', 'data_source_id')

        # Deleting field 'PostalAddress.data_source'
        db.delete_column(u'events_postaladdress', 'data_source_id')

        # Deleting field 'Offer.data_source'
        db.delete_column(u'events_offer', 'data_source_id')

        # Deleting field 'Category.data_source'
        db.delete_column(u'events_category', 'data_source_id')

        # Deleting field 'Organization.data_source'
        db.delete_column(u'events_organization', 'data_source_id')

        # Deleting field 'Language.data_source'
        db.delete_column(u'events_language', 'data_source_id')
    ...
    models = {
        ...
        u'events.postaladdress': {
            ...
            'available_language': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['events.Language']", 'null': 'True', 'blank': 'True'}),
