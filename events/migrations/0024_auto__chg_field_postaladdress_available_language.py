...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostalAddress.available_language'
        db.alter_column(u'events_postaladdress', 'available_language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Language'], null=True))

    def backwards(self, orm):

        # Changing field 'PostalAddress.available_language'
        db.alter_column(u'events_postaladdress', 'available_language_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['events.Language']))
