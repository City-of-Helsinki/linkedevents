...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_person', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Category.description'
        db.alter_column(u'events_category', 'description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Organization.description'
        db.alter_column(u'events_organization', 'description', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Person.description'
        db.alter_column(u'events_person', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Category.description'
        db.alter_column(u'events_category', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Organization.description'
        db.alter_column(u'events_organization', 'description', self.gf('django.db.models.fields.TextField')(null=True))
