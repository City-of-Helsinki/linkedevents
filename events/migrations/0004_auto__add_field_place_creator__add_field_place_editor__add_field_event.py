...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_place', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='place_creators', null=True, to=orm['events.Person']),
                      keep_default=False)

        # Adding field 'Place.editor'
        db.add_column(u'events_place', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='place_editors', null=True, to=orm['events.Person']),
                      keep_default=False)

        # Adding field 'Event.creator'
        db.add_column(u'events_event', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_creators', null=True, to=orm['events.Person']),
                      keep_default=False)

        # Adding field 'Event.editor'
        db.add_column(u'events_event', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_editors', null=True, to=orm['events.Person']),
                      keep_default=False)

        # Adding field 'Person.creator'
        db.add_column(u'events_person', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='person_creators', null=True, to=orm['events.Person']),
                      keep_default=False)

        # Adding field 'Person.editor'
        db.add_column(u'events_person', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='person_editors', null=True, to=orm['events.Person']),
                      keep_default=False)

        # Adding field 'Category.creator'
        db.add_column(u'events_category', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category_creators', null=True, to=orm['events.Person']),
                      keep_default=False)

        # Adding field 'Category.editor'
        db.add_column(u'events_category', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category_editors', null=True, to=orm['events.Person']),
                      keep_default=False)

        # Adding field 'Organization.creator'
        db.add_column(u'events_organization', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='organization_creators', null=True, to=orm['events.Person']),
                      keep_default=False)

        # Adding field 'Organization.editor'
        db.add_column(u'events_organization', 'editor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='organization_editors', null=True, to=orm['events.Person']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.creator'
        db.delete_column(u'events_place', 'creator_id')

        # Deleting field 'Place.editor'
        db.delete_column(u'events_place', 'editor_id')

        # Deleting field 'Event.creator'
        db.delete_column(u'events_event', 'creator_id')

        # Deleting field 'Event.editor'
        db.delete_column(u'events_event', 'editor_id')

        # Deleting field 'Person.creator'
        db.delete_column(u'events_person', 'creator_id')

        # Deleting field 'Person.editor'
        db.delete_column(u'events_person', 'editor_id')

        # Deleting field 'Category.creator'
        db.delete_column(u'events_category', 'creator_id')

        # Deleting field 'Category.editor'
        db.delete_column(u'events_category', 'editor_id')

        # Deleting field 'Organization.creator'
        db.delete_column(u'events_organization', 'creator_id')

        # Deleting field 'Organization.editor'
        db.delete_column(u'events_organization', 'editor_id')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'event_creators'", 'null': 'True', 'to': u"orm['events.Person']"}),
            'custom_fields': (u'django_hstore.fields.DictionaryField', [], {'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
