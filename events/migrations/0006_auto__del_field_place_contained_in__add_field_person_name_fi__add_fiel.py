...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'events_place', 'contained_in_id')

        # Adding field 'Person.name_fi'
        db.add_column(u'events_person', 'name_fi',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.name_sv'
        db.add_column(u'events_person', 'name_sv',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.name_en'
        db.add_column(u'events_person', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.description'
        db.add_column(u'events_person', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.description_fi'
        db.add_column(u'events_person', 'description_fi',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.description_sv'
        db.add_column(u'events_person', 'description_sv',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.description_en'
        db.add_column(u'events_person', 'description_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Offer.available_at_or_from'
        db.add_column(u'events_offer', 'available_at_or_from',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Place'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'events_place', 'contained_in',
                      self.gf('mptt.fields.TreeForeignKey')(related_name='children', null=True, to=orm['events.Place'], blank=True),
                      keep_default=False)

        # Deleting field 'Person.name_fi'
        db.delete_column(u'events_person', 'name_fi')

        # Deleting field 'Person.name_sv'
        db.delete_column(u'events_person', 'name_sv')

        # Deleting field 'Person.name_en'
        db.delete_column(u'events_person', 'name_en')

        # Deleting field 'Person.description'
        db.delete_column(u'events_person', 'description')

        # Deleting field 'Person.description_fi'
        db.delete_column(u'events_person', 'description_fi')

        # Deleting field 'Person.description_sv'
        db.delete_column(u'events_person', 'description_sv')

        # Deleting field 'Person.description_en'
        db.delete_column(u'events_person', 'description_en')

        # Deleting field 'Offer.available_at_or_from'
        db.delete_column(u'events_offer', 'available_at_or_from_id')
