...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.lft'
        db.add_column(u'events_place', u'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Place.rght'
        db.add_column(u'events_place', u'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Place.tree_id'
        db.add_column(u'events_place', u'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Place.level'
        db.add_column(u'events_place', u'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Place.lft'
        db.delete_column(u'events_place', u'lft')

        # Deleting field 'Place.rght'
        db.delete_column(u'events_place', u'rght')

        # Deleting field 'Place.tree_id'
        db.delete_column(u'events_place', u'tree_id')

        # Deleting field 'Place.level'
        db.delete_column(u'events_place', u'level')
