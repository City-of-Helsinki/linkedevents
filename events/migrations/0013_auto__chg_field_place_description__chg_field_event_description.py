...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_place', 'description', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Place.description'
        db.alter_column(u'events_place', 'description', self.gf('django.db.models.fields.TextField')(null=True))
