...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostalAddress.telephone_fi'
        db.add_column(u'events_postaladdress', 'telephone_fi',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostalAddress.telephone_sv'
        db.add_column(u'events_postaladdress', 'telephone_sv',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostalAddress.telephone_en'
        db.add_column(u'events_postaladdress', 'telephone_en',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostalAddress.street_address_fi'
        db.add_column(u'events_postaladdress', 'street_address_fi',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostalAddress.street_address_sv'
        db.add_column(u'events_postaladdress', 'street_address_sv',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostalAddress.street_address_en'
        db.add_column(u'events_postaladdress', 'street_address_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostalAddress.address_locality_fi'
        db.add_column(u'events_postaladdress', 'address_locality_fi',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostalAddress.address_locality_sv'
        db.add_column(u'events_postaladdress', 'address_locality_sv',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostalAddress.address_locality_en'
        db.add_column(u'events_postaladdress', 'address_locality_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostalAddress.telephone_fi'
        db.delete_column(u'events_postaladdress', 'telephone_fi')

        # Deleting field 'PostalAddress.telephone_sv'
        db.delete_column(u'events_postaladdress', 'telephone_sv')

        # Deleting field 'PostalAddress.telephone_en'
        db.delete_column(u'events_postaladdress', 'telephone_en')

        # Deleting field 'PostalAddress.street_address_fi'
        db.delete_column(u'events_postaladdress', 'street_address_fi')

        # Deleting field 'PostalAddress.street_address_sv'
        db.delete_column(u'events_postaladdress', 'street_address_sv')

        # Deleting field 'PostalAddress.street_address_en'
        db.delete_column(u'events_postaladdress', 'street_address_en')

        # Deleting field 'PostalAddress.address_locality_fi'
        db.delete_column(u'events_postaladdress', 'address_locality_fi')

        # Deleting field 'PostalAddress.address_locality_sv'
        db.delete_column(u'events_postaladdress', 'address_locality_sv')

        # Deleting field 'PostalAddress.address_locality_en'
        db.delete_column(u'events_postaladdress', 'address_locality_en')
