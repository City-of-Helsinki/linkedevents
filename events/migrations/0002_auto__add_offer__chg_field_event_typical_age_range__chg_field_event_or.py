...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_offer', (
            ...
            ('valid_through', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        # Changing field 'Event.typical_age_range'
        db.alter_column(u'events_event', 'typical_age_range', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Event.origin_id'
        db.alter_column(u'events_event', 'origin_id', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding unique constraint on 'Event', fields ['publisher', 'origin_id']
        db.create_unique(u'events_event', ['publisher_id', 'origin_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Event', fields ['publisher', 'origin_id']
        db.delete_unique(u'events_event', ['publisher_id', 'origin_id'])
        ...
        # Changing field 'Event.typical_age_range'
        db.alter_column(u'events_event', 'typical_age_range', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Event.origin_id'
        db.alter_column(u'events_event', 'origin_id', self.gf('django.db.models.fields.CharField')(max_length=50))
