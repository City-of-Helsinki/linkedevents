...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.logo'
        db.alter_column(u'events_place', 'logo', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Place.map'
        db.alter_column(u'events_place', 'map', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Place.logo'
        db.alter_column(u'events_place', 'logo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Place.map'
        db.alter_column(u'events_place', 'map', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
