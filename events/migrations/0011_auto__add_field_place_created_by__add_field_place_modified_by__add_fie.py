...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_place', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_place_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Place.modified_by'
        db.add_column(u'events_place', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_place_modified_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Event.created_by'
        db.add_column(u'events_event', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_event_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Event.modified_by'
        db.add_column(u'events_event', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_event_modified_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Person.created_by'
        db.add_column(u'events_person', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_person_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Person.modified_by'
        db.add_column(u'events_person', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_person_modified_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PostalAddress.created_by'
        db.add_column(u'events_postaladdress', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_postaladdress_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PostalAddress.modified_by'
        db.add_column(u'events_postaladdress', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_postaladdress_modified_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Offer.created_by'
        db.add_column(u'events_offer', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_offer_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Offer.modified_by'
        db.add_column(u'events_offer', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_offer_modified_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Category.created_by'
        db.add_column(u'events_category', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_category_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Category.modified_by'
        db.add_column(u'events_category', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_category_modified_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Organization.created_by'
        db.add_column(u'events_organization', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_organization_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Organization.modified_by'
        db.add_column(u'events_organization', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_organization_modified_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Language.created_by'
        db.add_column(u'events_language', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_language_created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Language.modified_by'
        db.add_column(u'events_language', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'events_language_modified_by', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.created_by'
        db.delete_column(u'events_place', 'created_by_id')

        # Deleting field 'Place.modified_by'
        db.delete_column(u'events_place', 'modified_by_id')

        # Deleting field 'Event.created_by'
        db.delete_column(u'events_event', 'created_by_id')

        # Deleting field 'Event.modified_by'
        db.delete_column(u'events_event', 'modified_by_id')

        # Deleting field 'Person.created_by'
        db.delete_column(u'events_person', 'created_by_id')

        # Deleting field 'Person.modified_by'
        db.delete_column(u'events_person', 'modified_by_id')

        # Deleting field 'PostalAddress.created_by'
        db.delete_column(u'events_postaladdress', 'created_by_id')

        # Deleting field 'PostalAddress.modified_by'
        db.delete_column(u'events_postaladdress', 'modified_by_id')

        # Deleting field 'Offer.created_by'
        db.delete_column(u'events_offer', 'created_by_id')

        # Deleting field 'Offer.modified_by'
        db.delete_column(u'events_offer', 'modified_by_id')

        # Deleting field 'Category.created_by'
        db.delete_column(u'events_category', 'created_by_id')

        # Deleting field 'Category.modified_by'
        db.delete_column(u'events_category', 'modified_by_id')

        # Deleting field 'Organization.created_by'
        db.delete_column(u'events_organization', 'created_by_id')

        # Deleting field 'Organization.modified_by'
        db.delete_column(u'events_organization', 'modified_by_id')

        # Deleting field 'Language.created_by'
        db.delete_column(u'events_language', 'created_by_id')

        # Deleting field 'Language.modified_by'
        db.delete_column(u'events_language', 'modified_by_id')
