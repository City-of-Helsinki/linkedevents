...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.SmallIntegerField(blank=True, db_index=True, null=True, verbose_name='Maximum recommended age'),
        ),
        migrations.AddField(
            model_name='event',
            name='audience_min_age',
            field=models.SmallIntegerField(blank=True, db_index=True, null=True, verbose_name='Minimum recommended age'),
        ),
        migrations.AddField(
            model_name='event',
            name='provider_contact_info',
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name="Provider's contact info"),
        ),
        migrations.AddField(
            model_name='event',
