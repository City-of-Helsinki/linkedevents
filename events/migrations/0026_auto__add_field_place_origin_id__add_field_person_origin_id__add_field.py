...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.origin_id'
        db.add_column(u'events_place', 'origin_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.origin_id'
        db.add_column(u'events_person', 'origin_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PostalAddress.origin_id'
        db.add_column(u'events_postaladdress', 'origin_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Offer.origin_id'
        db.add_column(u'events_offer', 'origin_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.origin_id'
        db.add_column(u'events_category', 'origin_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.origin_id'
        db.add_column(u'events_organization', 'origin_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Language.origin_id'
        db.add_column(u'events_language', 'origin_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.origin_id'
        db.delete_column(u'events_place', 'origin_id')

        # Deleting field 'Person.origin_id'
        db.delete_column(u'events_person', 'origin_id')

        # Deleting field 'PostalAddress.origin_id'
        db.delete_column(u'events_postaladdress', 'origin_id')

        # Deleting field 'Offer.origin_id'
        db.delete_column(u'events_offer', 'origin_id')

        # Deleting field 'Category.origin_id'
        db.delete_column(u'events_category', 'origin_id')

        # Deleting field 'Organization.origin_id'
        db.delete_column(u'events_organization', 'origin_id')

        # Deleting field 'Language.origin_id'
        db.delete_column(u'events_language', 'origin_id')
