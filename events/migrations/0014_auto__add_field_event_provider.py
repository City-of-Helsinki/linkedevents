...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_event', 'provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_providers', null=True, to=orm['events.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.provider'
        db.delete_column(u'events_event', 'provider_id')
