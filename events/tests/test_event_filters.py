...
def test_get_event_list_filter_multiple_weekdays(api_client):
    ...
    EventFactory(
        name="everyday",
        start_time=timezone.datetime(2025, 3, 10, 12, tzinfo=datetime_timezone.utc),
        end_time=timezone.datetime(2025, 3, 16, 12, tzinfo=datetime_timezone.utc),
    )
    EventFactory(
        name="over weekender",
        start_time=timezone.datetime(2025, 3, 14, 12, tzinfo=datetime_timezone.utc),
        end_time=timezone.datetime(2025, 3, 18, 12, tzinfo=datetime_timezone.utc),
    )
...
def test_get_event_list_filter_weekdays_spans_over_weekend(
    ...
    EventFactory(
        ...
        start_time=timezone.datetime(2025, 3, 11, 12, tzinfo=datetime_timezone.utc),
        end_time=timezone.datetime(2025, 3, 11, 14, tzinfo=datetime_timezone.utc),
    )
    EventFactory(
    ...
    EventFactory(
        ...
        start_time=timezone.datetime(2025, 3, 16, 12, tzinfo=datetime_timezone.utc),
        end_time=timezone.datetime(2025, 3, 19, 12, tzinfo=datetime_timezone.utc),
    )
...
def test_get_event_list_hide_recurring_children_weekday_matches_sub_events(api_client):
    ...
    thursday = timezone.datetime(2025, 3, 6, 12, tzinfo=datetime_timezone.utc)
