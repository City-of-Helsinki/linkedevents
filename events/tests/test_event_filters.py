...
@pytest.mark.django_db
def test_get_event_list_hide_recurring_children_weekdays_matches_sub_events(api_client):
    ...
    resp = get_list(
        api_client,
        query_string="weekday=4&hide_recurring_children=true&sub_events=true",
    )
    data = resp.data["data"]
...
def test_get_event_list_hide_recurring_children_start_matches_sub_events(api_client):
    ...
    resp = get_list(
        api_client,
        query_string="start=2025-03-06&hide_recurring_children=true&sub_events=true",
    )
    data = resp.data["data"]
