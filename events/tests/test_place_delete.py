...
@pytest.mark.django_db
def test__non_user_editable_cannot_delete_a_place(api_client, place, data_source, organization, user):
...
@pytest.mark.django_db
def test__user_editable_can_delete_a_place(api_client, place, data_source, organization, user):
    data_source.owner = organization
