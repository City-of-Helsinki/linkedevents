...
@pytest.mark.django_db
def test__api_key_with_organization_can_create_a_keyword(api_client, keyword_dict, data_source, organization):
...
@pytest.mark.django_db
def test__non_user_editable_cannot_create_keyword(api_client, keyword, keyword_dict, data_source, organization, user):
    data_source.owner = organization
...
@pytest.mark.django_db
def test__user_editable_can_create_keyword(api_client, keyword, keyword_dict, data_source, organization, user):
    data_source.owner = organization
