...
@pytest.mark.django_db
def test__cannot_create_an_place_with_existing_id(api_client, place_dict, user):
    api_client.force_authenticate(user=user)
...
@pytest.mark.django_db
def test__api_key_without_organization_cannot_create_a_place(
...
@pytest.mark.django_db
def test__non_user_editable_resources_cannot_create_a_place(
...
@pytest.mark.django_db
def test__user_editable_resources_can_create_a_place(
    api_client, place, place_dict, data_source, organization, user
):
    data_source.owner = organization
