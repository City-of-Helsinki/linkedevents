...
# Param 2: db master username
# Param 3: db master password
# Param 4: db migration username
# Param 5: db migration password
# Param 6: db application username
# Param 7: db application password
# Param 8: db name
# Param 9: db name
function init-db() {
